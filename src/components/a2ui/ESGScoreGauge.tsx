          ...
          >
            {environmental !== undefined && (
              <>
                ...
                <span className={`font-medium ${getScoreColor(environmental)}`}>
                  {environmental}
                </span>
              </>
            )}
            {social !== undefined && (
              <>
                ...
                <span className={`font-medium ${getScoreColor(social)}`}>
                  {social}
                </span>
              </>
            )}
            {governance !== undefined && (
              <>
                ...
                <span className={`font-medium ${getScoreColor(governance)}`}>
                  {governance}
                </span>
              </>
            )}
